  ...
  return (
    <main className="bg-white min-h-screen py-12 md:py-20">
      <div className="container mx-auto px-6 max-w-4xl">
        <Link 
          href="/" 
          className="text-blue-600 hover:text-blue-800 transition-colors mb-10 inline-flex items-center gap-2 font-medium"
        >
          <span>←</span> Вернуться на главную
        </Link>
        
        <article className="text-gray-900 leading-relaxed space-y-8 text-justify">
          <header className="text-center mb-12">
            <h1 className="text-2xl md:text-3xl font-bold uppercase tracking-tight">
              Политика <br />
              общества с ограниченной ответственностью «Кинокомпания Ви Эн Ти» <br />
              в отношении обработки персональных данных
            </h1>
          </header>

          <section>
            <h2 className="text-xl font-bold mb-4 border-b-2 border-gray-100 pb-2">1. Общие положения</h2>
            <div className="space-y-4">
              <p>1.1. Настоящая Политика общества с ограниченной ответственностью «Кинокомпания Ви Эн Ти» в отношении обработки персональных данных (далее - Политика) разработана во исполнение требований п. 2 ч. 1 ст. 18.1 Федерального закона от 27.07.2006 N 152-ФЗ "О персональных данных" (далее - Закон о персональных данных) в целях обеспечения защиты прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.</p>
              <p>1.2. Политика действует в отношении всех персональных данных, которые обрабатывает общество с ограниченной ответственностью «Кинокомпания Ви Эн Ти» (далее - Оператор, ООО «Кинокомпания Ви Эн Ти»).</p>
              ...
              <div className="space-y-4 pt-4">
                <p><strong>1.5. Основные понятия, используемые в Политике:</strong></p>
              ...
              <div className="space-y-4 pt-4">
                <p><strong>1.6. Основные права и обязанности Оператора.</strong></p>
              ...
              <div className="space-y-4 pt-4">
                <p><strong>1.7. Основные права субъекта персональных данных.</strong></p>
              ...
              <p>1.9. Ответственность за нарушение требований законодательства Российской Федерации и нормативных актов ООО «Кинокомпания Ви Эн Ти» в сфере обработки и защиты персональных данных определяется в соответствии с законодательством Российской Федерации.</p>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-4 border-b-2 border-gray-100 pb-2">2. Цели обработки персональных данных</h2>
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-8 space-y-1">
                <li>установления и прекращения трудовых отношений с физическими лицами;</li>
                <li>выполнения договорных обязательств перед контрагентами;</li>
                <li>управления проведения корпоративных процедур Общества;</li>
                <li>проверки благонадежности контрагентов;</li>
                <li>учета доверенных (уполномоченных) лиц контрагентов.</li>
              </ul>
          ...
          <section>
            <h2 className="text-xl font-bold mb-4 border-b-2 border-gray-100 pb-2">3. Правовые основания обработки персональных данных</h2>
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-8 space-y-1">
                <li>устав ООО «Кинокомпания Ви Эн Ти»;</li>
          ...
          <section>
            <h2 className="text-xl font-bold mb-4 border-b-2 border-gray-100 pb-2">4. Объем и категории обрабатываемых персональных данных, категории субъектов персональных данных</h2>
            <div className="space-y-6">
              ...
              <div className="pl-4 border-l-4 border-gray-50 space-y-4">
                <p><strong>4.2.1. Кандидаты для приема на работу к Оператору</strong> - для целей исполнения трудового законодательства в рамках трудовых и иных непосредственно связанных с ним отношений:</p>
                <ul className="list-disc pl-8 space-y-1">
                ...
                <p><strong>4.2.2. Работники и бывшие работники Оператора</strong> - для целей исполнения трудового законодательства в рамках трудовых и иных непосредственно связанных с ним отношений, осуществления пропускного режима:</p>
                <ul className="list-disc pl-8 space-y-1">
                  <li>фамилия, имя, отчество;</li>
                  <li>пол;</li>
                  <li>гражданство;</li>
                ...
                <p><strong>4.2.3. Клиенты и контрагенты Оператора (физические лица)</strong> - для целей осуществления своей деятельности в соответствии с уставом ООО «Кинокомпания Ви Эн Ти»:</p>
                <ul className="list-disc pl-8 space-y-1">
                  <li>фамилия, имя, отчество;</li>
                  <li>дата и место рождения;</li>
                  <li>паспортные данные;</li>
                ...
                <p><strong>4.2.4. Представители (работники) клиентов и контрагентов Оператора (юридических лиц)</strong> - для целей осуществления своей деятельности в соответствии с уставом ООО «Кинокомпания Ви Эн Ти», осуществления пропускного режима:</p>
                <ul className="list-disc pl-8 space-y-1">
                  <li>фамилия, имя, отчество;</li>
                  <li>паспортные данные;</li>
                  <li>контактные данные;</li>
          ...
          <section>
            <h2 className="text-xl font-bold mb-4 border-b-2 border-gray-100 pb-2">5. Порядок и условия обработки персональных данных</h2>
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-8 space-y-1">
                ...
                <li>назначает лиц, ответственных за обеспечение безопасности персональных данных в информационной системе Оператора;</li>
              ...
              <p>5.9.1. Персональные данные на бумажных носителях хранятся в ООО «Кинокомпания Ви Эн Ти» в течение сроков хранения документов, для которых эти сроки предусмотрены законодательством об архивном деле в РФ (Федеральный закон от 22.10.2004 N 125-ФЗ "Об архивном деле в Российской Федерации", Перечень типовых управленческих архивных документов, образующихся в процессе деятельности государственных органов, органов местного самоуправления и организаций, с указанием сроков их хранения (утв. Приказом Росархива от 20.12.2019 N 236).</p>
              ...
              <ul className="list-disc pl-8 space-y-1">
                ...
                <li>истек срок действия или отозвано согласие субъекта персональных данных на обработку указанных данных, когда по Закону о персональных данных обработка этих данных допускается только с согласия субъекта персональных данных.</li>
              </ul>
          ...
          <section>
            <h2 className="text-xl font-bold mb-4 border-b-2 border-gray-100 pb-2">6. Актуализация, исправление, удаление, уничтожение персональных данных, ответы на запросы субъектов на доступ к персональным данным</h2>
            <div className="space-y-4">
              ...
              <div className="space-y-4 pt-4">
                <p><strong>6.5. Порядок уничтожения персональных данных Оператором.</strong></p>
                ...
                <p>6.5.3. Уничтожение персональных данных осуществляет комиссия, созданная приказом директора ООО «Кинокомпания Ви Эн Ти».</p>
